    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form action="login" method="POST">
          <input type="text" name="userName" id="userName" class="username form-control" placeholder="Username" required/>
          <input type="password" name="password" id="password" class="password form-control" placeholder="password" required/>
